...
let localFiters: [filter] = [
    ...
    filter(name: "Orange and teal 2", tags: "color", filterFileURL: "https://kazantsev-ef.ru/ios/filters/Orange_and_teal/Orange_and_teal_2_filter.dng", imageBefore:  "LOCAL_Orange and teal 2_before", imageAfter:  "LOCAL_Orange and teal 2_after", filterSettings:
    ...
    filter(name: "Pinky teal", tags: "summer,color", filterFileURL: "https://kazantsev-ef.ru/ios/filters/Pinky_teal/Pinky_teal_filter.dpg", imageBefore:  "LOCAL_Pinky teal_before", imageAfter:  "LOCAL_Pinky teal_after", filterSettings:
            imageSettings(exposure: "-0.25", contrast: "-26", highlights: "-71", shadows: "83", whites: "-60", blacks: "13", temperature: "9", tint: "-22", vibrance: "0", saturation: "-21", texture: "0", clarity: "0", dehaze: "0", vignette: "0", grain: "0", size: "25", roughness: "50", sharpening: "54", radius: "1", detail: "25", masking: "0"), isInPack: "0"),
